...
ifeq ($(F405), 1)
  PROJ_OBJ += mpu6500.o motors_f405.o i2cdev_f405.o ws2812.o lps25h.o ak8963.o eeprom.o hcsr04.o
...
PROJ_OBJ += log.o worker.o neopixelring.o ultrasonic.o expbrd.o
